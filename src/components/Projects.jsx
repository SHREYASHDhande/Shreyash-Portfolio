        ...
        <div className="min-h-screen px-12 md:px-0 bg-black text-white p-4 md:p-8 lg:p-16" id="projects">
            <div className="max-w-7xl mx-auto">
                ...
                <ProjectCard 
                    ...
                    description="A machine learning-based disease prediction system using Flask. Analyzes health data to predict diseases, built with Flask for backend processing and integration." 
                    image="/disease-prediction.png" 
                />
                <ProjectCard 
    title="Sign Language to Text Prediction" 
    description="A machine learning system for converting sign language gestures to text in real-time. Built with python and TensorFlow for gesture recognition and seamless processing." 
    image="/sign-language-text.png" 
  />
</div>
<div className="grid md:grid-cols-2 md:gap-6">
